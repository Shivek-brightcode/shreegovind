...
include_once "dbconnection.php";
	...
	if($status=='paid')
	{
		$sql="select * from `student_payment_updation` where class='$cls' and dues_amount='0'  limit $offset, $count";
		$sql1="select count(admission_no) as count from `student_payment_updation` where class='$cls' and dues_amount='0'";
                               ...
                               <?php 
							     if($page>1){
									   ?>
										...
										<li><a href ="default_list_report.php?status=<?php echo $status;?>&cls=<?php echo $cls;?>&page=<?php echo $prev;?>">prev</a></li>
								...
								for($i=0;$i<ceil($pages);$i++){
									if($i==$page-1){
								   ?>
									   <li class="active"><a href="default_list_report.php?status=<?php echo $status;?>&cls=<?php echo $cls;?>&page=<?php echo $i ?>"><?php echo $i+1;?> </a></li>
									 <?php   
									 }
									 else{
								   ?>
									   <li><a href="default_list_report.php?status=<?php echo $status;?>&cls=<?php echo $cls;?>&page=<?php echo $i ?>"><?php echo $i+1;?> </a></li>
									 <?php   
									 }
								   }//for closed			 
							       if($page<ceil($pages)){
											?>	
											<li><a href="default_list_report.php?status=<?php echo $status;?>&cls=<?php echo $cls;?>&page=<?php echo $page;?>">next</a></li>
										   <?php 
