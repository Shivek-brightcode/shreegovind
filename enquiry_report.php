...
window.onload=function(){
	...
	var xhttp = new XMLHttpRequest();
		...
		xhttp.open("GET", "enquiry_report_ajax.php?from="+from+"&to="+to+"&page="+page, true);
	 	xhttp.send();
    ...
    <div class="row">
     <div class="col-md-12">
        ...
        <br />
          ...
          <?php  //include "enquiry_report_ajax.php"; ?>
  ...
  function getRep(){
	...
	$("#search_value").val("");
	  ...
	  if(to==""){
		...
		xhttp.open("GET", "enquiry_report_ajax.php?from="+from+"&to="+to, true);
	 	xhttp.send();
