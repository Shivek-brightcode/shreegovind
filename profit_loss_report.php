...
.errspan {
    ...
    <script>
		...
		xhttp.open("GET", "income_report.php?page="+page, true);
	 	xhttp.send();}
		}
    </script>
</head>
     ...
     <div class="col-md-12">
     	<div class="row">
        	<div class="col-md-4"></div><!-- col-md-4 closed -->
        	 <div class="col-md-4">
                 <h3 class="text-center">Profit/Loss Reports</h3>
                 <hr class="style13"/><br />
             </div>
               ...
               <div class="row">
                    	...
                    	<div class="row">
                            <!--<div class=" col-md-8 col-sm-8 col-xs-8">
                               <button class="btn btn-primary" onclick="getIncome();" name="income" id="income" >Income</button>
                               <button class="btn btn-warning" onclick="getDailyExpenses();" name="expense" id="expense" >Daily Expenses</button> 
                               <button class="btn btn-danger" onclick="getSalaryExpenses();" name="expense" id="expense" >Salary Expenses</button>
                            </div>-->
                        </div>
...
<script>
  ...
  function getRep(){
	...
	$("#search_value").val("");
	  ...
	  if(to==""){
		...
		xhttp.open("GET", "profit_loss_report_ajax.php?from="+from+"&to="+to, true);
	 	xhttp.send();
  ...
  function getIncome(){
		...
		xhttp.open("GET", "income_report.php", true);
	 	xhttp.send();
   ...
   function getDailyExpenses(){
		...
		xhttp.open("GET", "daily_expense_report.php", true);
	 	xhttp.send();

	  
  } 
    function getSalaryExpenses(){
		  var xhttp = new XMLHttpRequest();
 	      xhttp.onreadystatechange = function() {
			  if (xhttp.readyState == 4 && xhttp.status == 200) {
				document.getElementById("searched_value_as_report").innerHTML = xhttp.responseText;
		...
		xhttp.open("GET", "salary_expense_report.php", true);
	 	xhttp.send();
