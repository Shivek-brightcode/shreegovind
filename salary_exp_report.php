...
window.onload=function(){
	...
	if(to!="" && from!=""){
	 ...
	 var xhttp = new XMLHttpRequest();
		...
		xhttp.open("GET", "salary_report_ajax.php?from="+from+"&to="+to+"&page="+page, true);
	 	xhttp.send();
}
     ...
     <div class="col-md-12">
     	<div class="row">
        	<div class="col-md-4"></div><!-- col-md-4 closed -->
        	 <div class="col-md-4">
                 <h3 class="text-center">Salary Expenditure Reports</h3>
                 <hr class="style13"/><br />
             </div>
  ...
  function getRep(){
	...
	$("#search_value").val("");
	  ...
	  if(to==""){
		...
		xhttp.open("GET", "salary_report_ajax.php?from="+from+"&to="+to, true);
	 	xhttp.send();
